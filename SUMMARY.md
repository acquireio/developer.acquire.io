...
* [Platform](rest-apis/platform/README.md)
  ...
  * [Conversation](rest-apis/platform/conversation/README.md)
    * [Messages](rest-apis/platform/conversation/messages/README.md)
      * [Retrieve a list of messages](rest-apis/platform/conversation/messages/list-messages.md)
      * [Retrieve a message](rest-apis/platform/conversation/messages/get.md)
      * [Send a message](rest-apis/platform/conversation/messages/add.md)
      * [Update message](rest-apis/platform/conversation/messages/update.md)
...
* [Settings / Configuration](rest-apis/settings-configuration/README.md)
  ...
  * [Login Settings](rest-apis/settings-configuration/login-settings/README.md)
    * [Get](rest-apis/settings-configuration/login-settings/get.md)
    * [Add](rest-apis/settings-configuration/login-settings/add.md)
