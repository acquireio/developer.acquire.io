...
5. **`card :`** Under this type, you can show carousel card and browse carousel card in chat widget.
6. **`multiple-tasks`**`:` Indicates that response data have multiple actions or task.
...
### Example 7. In case of multiple responses:
